...
export default (props) => {
	...
	return (
		<div className="flex flex-col bg-white">
			<div className="self-stretch bg-white h-[1183px] rounded-lg border-2 border-solid border-[#CED4DA]">
				<div className="flex justify-between items-start self-stretch bg-[#161B22] py-3.5 px-4">
					<div className="flex shrink-0 items-start gap-8">
						<img
							src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/1efiyh4c_expires_30_days.png"} 
						...
						<div className="flex shrink-0 items-start">
							...
							<div className="flex shrink-0 items-center py-[11px] gap-[13px] rounded-md">
								...
								<img
									src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/ouvh6uc3_expires_30_days.png"} 
					...
					<div className="flex shrink-0 items-center gap-4">
						...
						<div className="flex shrink-0 items-center bg-[#161B22] py-2.5 px-3 gap-2 rounded-md border border-solid border-[#30363D]">
							<img
								src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/kc35dr81_expires_30_days.png"} 
								className="w-5 h-5 rounded-md object-fill"
							/>
							<img
								src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/jry190tn_expires_30_days.png"} 
								className="w-3 h-[15px] rounded-md object-fill"
							/>
						</div>
						<button className="flex shrink-0 items-center bg-[#161B22] text-left py-2.5 px-4 gap-2.5 rounded-md border border-solid border-[#30363D]"
							onClick={()=>alert("Pressed!")}>
							<img
								src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/l2is61sm_expires_30_days.png"} 
				...
				<div className="flex items-start self-stretch p-2">
							...
							<div className="flex justify-between items-start self-stretch mx-3">
								<div className="flex shrink-0 items-center gap-4">
									<div className="flex shrink-0 items-start pr-[1px] gap-2">
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/pb1upmrt_expires_30_days.png"} 
									...
									<div className="flex shrink-0 items-center p-3 gap-[13px] rounded-md">
										...
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/jfl3dhz7_expires_30_days.png"} 
											className="w-3 h-[15px] rounded-md object-fill"
										/>
									</div>
								</div>
								<div className="flex shrink-0 items-start gap-2.5">
									<button className="flex shrink-0 items-center bg-[#0D1117] text-left p-3 gap-[17px] rounded-md border border-solid border-[#30363D]"
										...
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/a2gqk2r7_expires_30_days.png"} 
											className="w-3 h-[15px] rounded-md object-fill"
										/>
									</button>
									<button className="flex shrink-0 items-center bg-[#0D1117] text-left p-3 gap-4 rounded-md border border-solid border-[#30363D]"
										...
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/jualhccj_expires_30_days.png"} 
											className="w-3 h-[15px] rounded-md object-fill"
										/>
									</button>
								</div>
						...
						<div className="self-stretch bg-[#161B22] py-[1px] rounded-md border border-solid border-[#30363D]">
							...
							<div className="flex justify-between items-start self-stretch px-3 mx-[1px]">
								...
								<div className="flex shrink-0 items-center py-[15px] pl-2 pr-[7px] gap-[13px]">
									...
									<img
										src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/52xqft67_expires_30_days.png"} 
							...
							<div className="flex flex-col self-stretch py-3 mx-[1px] gap-2.5">
								<div className="self-stretch mx-3">
									<div className="flex items-center self-stretch">
										<span className="text-[#8B949E] text-xs font-bold my-[7px] ml-[1px] mr-[71px]" >
											{"Coin"}
										</span>
										<span className="text-[#8B949E] text-xs font-bold my-[9px] ml-2.5" >
											{"Position"}
										</span>
										<span className="text-[#8B949E] text-xs font-bold w-[49px] my-2.5 ml-2.5 mr-10" >
											{"Funding Rate"}
										</span>
										<span className="text-[#8B949E] text-xs font-bold my-[9px] ml-2.5 mr-[11px]" >
											{"PNL (ROE%)"}
										</span>
										<span className="text-[#8B949E] text-xs font-bold my-[9px] ml-2.5 mr-8" >
											{"Liq. Price"}
										</span>
										<span className="text-[#8B949E] text-xs font-bold my-[9px] ml-2.5 mr-[47px]" >
											{"Margin"}
										</span>
										<span className="text-[#8B949E] text-xs font-bold my-[9px] ml-2.5 mr-[52px]" >
											{"TP/SL"}
										</span>
										<span className="text-[#8B949E] text-xs font-bold my-[9px] ml-2.5 mr-10" >
											{"Actions"}
										</span>
									</div>
									<div className="flex items-center self-stretch">
										<div className="flex flex-col shrink-0 items-start py-2 gap-1">
											<span className="text-white text-xs ml-[1px]" >
												{"xAAPL"}
											</span>
											<div className="flex flex-col items-start mx-[1px] gap-1">
												<div className="flex items-start gap-1">
													<div className="flex flex-col shrink-0 items-start bg-[#30363D] py-1 px-2 rounded">
												...
												<div className="flex flex-col items-start bg-[#30363D] py-1 px-2 rounded">
													<span className="text-[#8B949E] text-[10px] font-bold" >
														{"$12.50/day"}
													</span>
												</div>
										...
										<div className="flex flex-1 flex-col items-start py-2.5 gap-1">
											<span className="text-white text-xs mx-2.5" >
												{"$25,000 @227.10"}
											</span>
											<div className="flex flex-col items-start bg-[#30363D] py-1 px-2 ml-2.5 rounded">
												<span className="text-[#8B949E] text-[10px] font-bold" >
													{"Long"}
												</span>
											</div>
										</div>
										<span className="text-white text-xs my-2.5 ml-2.5 mr-9" >
											{"+0.0100%"}
										</span>
										<div className="flex flex-col shrink-0 items-start py-2.5 mr-[1px] gap-1">
											<span className="text-white text-xs ml-2.5" >
												{"+$98.00"}
											</span>
											<div className="flex flex-col items-start bg-[#22C55E1A] py-1 px-2 ml-2.5 rounded">
												<span className="text-[#2DA44E] text-[10px] font-bold" >
													{"+3.92%"}
												</span>
											</div>
										</div>
										<span className="text-white text-xs my-2.5 ml-2.5 mr-[53px]" >
											{"198.20"}
										</span>
										<div className="flex flex-col shrink-0 items-start py-2.5 mr-[1px] gap-1">
											<span className="text-white text-xs ml-2.5" >
										...
										<div className="flex shrink-0 items-center py-[9px] px-2.5 gap-[7px]">
										...
										<span className="text-[#92318D] text-xs font-bold my-2.5 ml-2.5 mr-[57px]" >
											{"Close"}
										</span>
									</div>
								</div>
								<div className="flex flex-col items-end self-stretch">
									<div className="flex flex-col bg-[#92318D] w-[100px] py-3.5 mr-3 rounded-md">
										<span className="text-white text-base font-bold text-center mx-4" >
											{"Close All"}
										</span>
									</div>
								</div>
					...
					<div className="flex flex-col shrink-0 items-center pb-6">
						<div className="flex flex-col items-center bg-[#161B22] rounded-md border border-solid border-[#30363D]">
							<div className="flex items-start p-3">
								...
								<button className="flex shrink-0 items-start bg-[#0D1117] text-left p-3 mr-2 gap-[11px] rounded-md border border-solid border-[#30363D]"
									...
									<img
										src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/8pq1vgjg_expires_30_days.png"} 
										className="w-3 h-[15px] rounded-md object-fill"
									/>
								</button>
							...
							<div className="flex flex-col items-start py-4 gap-4">
								<div className="flex items-center bg-[#0D1117] p-1 mx-4 gap-[25px] rounded-md">
								...
								<div className="flex flex-col items-start mx-4 gap-2">
									...
									<div className="flex flex-col items-start gap-4">
										<div className="flex items-center bg-[#0D1117] py-[9px] px-3 rounded-md border border-solid border-[#30363D]">
											...
											<div className="flex shrink-0 items-start bg-[#30363D] py-[7px] px-2 gap-1.5 rounded">
												...
												<img
													src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/kai3n7lx_expires_30_days.png"} 
										...
										<div className="flex flex-col items-end bg-[#30363D] pr-[161px] rounded-[9999px]">
											...
											<img
												src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/ccb4d37k_expires_30_days.png"} 
								...
								<div className="flex flex-col items-start mx-4 gap-2">
									<div className="flex items-center py-2 gap-[58px]">
										<span className="text-[#C9D1D9] text-sm" >
									...
									<div className="flex items-start gap-[9px]">
										...
										<div className="flex flex-col shrink-0 items-start gap-[9px]">
											...
											<input
												...
												className="text-[#8B949E] bg-[#0D1117] text-xs font-bold py-4 px-[97px] rounded-md border border-solid border-[#30363D]"
											/>
										</div>
									</div>
									<div className="flex items-start gap-[9px]">
								...
								<div className="flex flex-col items-start bg-[#0D1117] py-3 mx-4 rounded-lg">
									<div className="flex items-center mb-2 ml-3 gap-2">
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/3w1sh8e4_expires_30_days.png"} 
								...
								<div className="flex flex-col items-start pt-4 mx-4 gap-2">
