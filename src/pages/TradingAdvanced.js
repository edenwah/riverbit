...
export default (props) => {
	...
	return (
		<div className="flex flex-col bg-white">
			<div className="self-stretch bg-white h-[1433px] rounded-lg border-2 border-solid border-[#CED4DA]">
				<div className="flex justify-between items-start self-stretch bg-[#161B22] py-3.5 px-4">
					<div className="flex shrink-0 items-start gap-8">
						<img
							src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/f1qdjarg_expires_30_days.png"} 
						...
						<div className="flex shrink-0 items-start">
							...
							<div className="flex shrink-0 items-center py-[11px] gap-[13px] rounded-md">
								...
								<img
									src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/zaihhujn_expires_30_days.png"} 
					...
					<div className="flex shrink-0 items-center gap-4">
						...
						<div className="flex shrink-0 items-center bg-[#161B22] py-2.5 px-3 gap-2 rounded-md border border-solid border-[#30363D]">
							<img
								src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/a5kyoul1_expires_30_days.png"} 
								className="w-5 h-5 rounded-md object-fill"
							/>
							<img
								src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/uj0uuo26_expires_30_days.png"} 
								className="w-3 h-[15px] rounded-md object-fill"
							/>
						</div>
						<button className="flex shrink-0 items-center bg-[#161B22] text-left py-2.5 px-4 gap-2.5 rounded-md border border-solid border-[#30363D]"
							onClick={()=>alert("Pressed!")}>
							<img
								src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/oy1yo4ws_expires_30_days.png"} 
							...
							<div className="flex justify-between items-start self-stretch mx-3">
								<div className="flex shrink-0 items-center gap-4">
									<div className="flex shrink-0 items-start pr-[1px] gap-2">
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/zu3ku6vd_expires_30_days.png"} 
									...
									<div className="flex shrink-0 items-center p-3 gap-[13px] rounded-md">
										...
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/c1fo21dn_expires_30_days.png"} 
											className="w-3 h-[15px] rounded-md object-fill"
										/>
									</div>
								</div>
								<div className="flex shrink-0 items-start gap-2.5">
									<button className="flex shrink-0 items-center bg-[#0D1117] text-left p-3 gap-[17px] rounded-md border border-solid border-[#30363D]"
										...
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/5gkwalk2_expires_30_days.png"} 
											className="w-3 h-[15px] rounded-md object-fill"
										/>
									</button>
									<button className="flex shrink-0 items-center bg-[#0D1117] text-left p-3 gap-4 rounded-md border border-solid border-[#30363D]"
										...
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/yqjnsjff_expires_30_days.png"} 
											className="w-3 h-[15px] rounded-md object-fill"
										/>
									</button>
								</div>
						...
						<div className="self-stretch bg-[#161B22] py-[1px] rounded-md border border-solid border-[#30363D]">
							...
							<div className="flex justify-between items-start self-stretch px-3 mx-[1px]">
								...
								<div className="flex shrink-0 items-center py-[15px] pl-2 pr-[7px] gap-[13px]">
									...
									<img
										src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/axraflh2_expires_30_days.png"} 
					...
					<div className="flex flex-col shrink-0 items-center bg-[#161B22] rounded-md border border-solid border-[#30363D]">
						<div className="flex items-start p-3">
							...
							<button className="flex shrink-0 items-start bg-[#0D1117] text-left p-3 mr-2 gap-[11px] rounded-md border border-solid border-[#30363D]"
								...
								<img
									src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/2hkdkk26_expires_30_days.png"} 
									className="w-3 h-[15px] rounded-md object-fill"
								/>
							</button>
						...
						<div className="flex items-start px-3">
							<span className="text-[#8B949E] text-sm my-[15px] ml-[19px] mr-5" >
								{"Market"}
							</span>
							<span className="text-[#8B949E] text-sm my-[15px] ml-[27px] mr-7" >
								{"Limit"}
							</span>
							<span className="text-white text-sm my-[15px] mx-[9px]" >
								{"Advanced"}
							</span>
						</div>
						<div className="flex flex-col items-start py-4 gap-4">
							...
							<div className="flex flex-col items-start mx-4 gap-2">
								...
								<button className="flex items-center bg-[#0D1117] text-left p-3 rounded-md border border-solid border-[#30363D]"
									onClick={()=>alert("Pressed!")}>
								...
								<div className="flex flex-col items-start gap-4">
									<div className="flex items-center bg-[#0D1117] py-[9px] px-3 rounded-md border border-solid border-[#30363D]">
										...
										<div className="flex shrink-0 items-start bg-[#30363D] py-[7px] px-2 gap-1.5 rounded">
											...
											<img
												src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/zxri784j_expires_30_days.png"} 
									...
									<div className="flex flex-col items-end bg-[#30363D] pr-[161px] rounded-[9999px]">
										...
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/nq2w9vzn_expires_30_days.png"} 
							...
							<div className="flex items-center mx-4 gap-[9px]">
								<div className="flex flex-col shrink-0 items-start">
									...
									<span className="text-white text-base my-3 ml-3 mr-[86px]" >
										{"0.5"}
									</span>
								</div>
								<div className="flex flex-col shrink-0 items-start gap-[9px]">
									<div className="flex items-center gap-2">
										...
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/qm2v8pb9_expires_30_days.png"} 
											className="w-3 h-3 object-fill"
										/>
									</div>
									<button className="flex items-center bg-[#0D1117] text-left p-3 gap-[53px] rounded-md border border-solid border-[#30363D]"
										onClick={()=>alert("Pressed!")}>
										<span className="text-white text-base" >
											{"GTC"}
										</span>
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/ph23z5ei_expires_30_days.png"} 
											className="w-3 h-[15px] rounded-md object-fill"
										/>
									</button>
								</div>
							...
							<div className="flex flex-col items-start bg-[#0D1117] py-3 mx-4 rounded-lg">
								<div className="flex items-center mb-2 ml-3 gap-2">
									<img
										src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/aigplhx5_expires_30_days.png"} 
							...
							<div className="flex flex-col items-start pt-4 mx-4 gap-2">
								...
								<div className="flex flex-col items-start gap-1">
									<div className="flex items-center pr-0.5">
										<span className="text-[#9D9DAF] text-xs mr-[90px]" >
											{"Liquidation Price:"}
										</span>
										<span className="text-white text-xs" >
											{"$39,130.00"}
									...
									<div className="flex items-center pr-0.5">
										<span className="text-[#9D9DAF] text-xs mr-[169px]" >
											{"Est. Fee:"}
										</span>
										<span className="text-white text-xs" >
											{"$2.50"}
