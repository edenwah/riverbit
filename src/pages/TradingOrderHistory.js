...
export default (props) => {
	...
	return (
		<div className="flex flex-col bg-white">
			<div className="self-stretch bg-white h-[1204px] rounded-lg border-2 border-solid border-[#CED4DA]">
				<div className="flex justify-between items-start self-stretch bg-[#161B22] py-3.5 px-4">
					<div className="flex shrink-0 items-start gap-8">
						<img
							src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/ciuna0ug_expires_30_days.png"} 
						...
						<div className="flex shrink-0 items-start">
							...
							<div className="flex shrink-0 items-center py-[11px] gap-[13px] rounded-md">
								...
								<img
									src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/gjy01upv_expires_30_days.png"} 
					...
					<div className="flex shrink-0 items-center gap-4">
						...
						<div className="flex shrink-0 items-center bg-[#161B22] py-2.5 px-3 gap-2 rounded-md border border-solid border-[#30363D]">
							<img
								src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/ipu5jy7p_expires_30_days.png"} 
								className="w-5 h-5 rounded-md object-fill"
							/>
							<img
								src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/l5yzr2s5_expires_30_days.png"} 
								className="w-3 h-[15px] rounded-md object-fill"
							/>
						</div>
						<button className="flex shrink-0 items-center bg-[#161B22] text-left py-2.5 px-4 gap-2.5 rounded-md border border-solid border-[#30363D]"
							onClick={()=>alert("Pressed!")}>
							<img
								src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/qttwc8jh_expires_30_days.png"} 
				...
				<div className="flex items-start self-stretch p-2">
							...
							<div className="flex justify-between items-start self-stretch mx-3">
								<div className="flex shrink-0 items-center gap-4">
									<div className="flex shrink-0 items-start pr-[1px] gap-2">
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/5gapo0z1_expires_30_days.png"} 
									...
									<div className="flex shrink-0 items-center p-3 gap-[13px] rounded-md">
										...
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/oxpvpvnq_expires_30_days.png"} 
											className="w-3 h-[15px] rounded-md object-fill"
										/>
									</div>
								</div>
								<div className="flex shrink-0 items-start gap-2.5">
									<button className="flex shrink-0 items-center bg-[#0D1117] text-left p-3 gap-[17px] rounded-md border border-solid border-[#30363D]"
										...
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/gyd4zb9m_expires_30_days.png"} 
											className="w-3 h-[15px] rounded-md object-fill"
										/>
									</button>
									<button className="flex shrink-0 items-center bg-[#0D1117] text-left p-3 gap-4 rounded-md border border-solid border-[#30363D]"
										...
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/1jqc7z07_expires_30_days.png"} 
											className="w-3 h-[15px] rounded-md object-fill"
										/>
									</button>
								</div>
						...
						<div className="self-stretch bg-[#161B22] py-[1px] rounded-md border border-solid border-[#30363D]">
							...
							<div className="flex justify-between items-start self-stretch px-3 mx-[1px]">
								...
								<div className="flex shrink-0 items-center py-[15px] pl-2 pr-[7px] gap-[13px]">
									...
									<img
										src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/vp8dl9q6_expires_30_days.png"} 
							...
							<div className="flex flex-col self-stretch py-3 mx-[1px] gap-2.5">
								<div className="self-stretch mx-3">
									<div className="flex items-center self-stretch">
										<span className="text-[#8B949E] text-xs font-bold my-[9px]" >
											{"Time"}
										</span>
										<span className="text-[#8B949E] text-xs font-bold my-[9px] ml-1" >
											{"Type"}
										</span>
										<span className="text-[#8B949E] text-xs font-bold my-[9px] ml-1 mr-[1px]" >
											{"Coin"}
										</span>
										<span className="flex-1 text-[#8B949E] text-xs font-bold my-[9px] mx-1" >
											{"Direction"}
										</span>
										<span className="flex-1 text-[#8B949E] text-xs font-bold my-2.5 ml-1 mr-[5px]" >
											{"Size / Filled Size"}
										</span>
										<span className="text-[#8B949E] text-xs font-bold w-[35px] my-2.5 ml-1" >
											{"Order Value"}
										</span>
										<span className="flex-1 text-[#8B949E] text-xs font-bold my-2.5 ml-1 mr-[5px]" >
											{"Price / Trigger"}
										</span>
										<span className="flex-1 text-[#8B949E] text-xs font-bold my-2.5 mx-1" >
											{"Reduce Only"}
										</span>
										<span className="text-[#8B949E] text-xs font-bold my-[9px] ml-1" >
											{"TP/SL"}
									...
									<div className="flex items-center self-stretch">
										...
										<span className="flex-1 text-white text-xs my-2.5 mx-1" >
											{"Take Profit Market"}
										</span>
										<span className="text-white text-xs my-[9px] ml-1 mr-[1px]" >
											{"HYPE"}
										</span>
										<span className="flex-1 text-[#F85149] text-xs my-[9px] mx-1" >
											{"Close Long"}
										</span>
										<span className="text-white text-xs my-[9px] ml-1 mr-[1px]" >
											{"-- / --"}
					...
					<div className="flex flex-col shrink-0 items-center pb-[45px]">
						<div className="flex flex-col items-center bg-[#161B22] rounded-md border border-solid border-[#30363D]">
							<div className="flex items-start p-3">
								...
								<button className="flex shrink-0 items-start bg-[#0D1117] text-left p-3 mr-2 gap-[11px] rounded-md border border-solid border-[#30363D]"
									...
									<img
										src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/qkxiyr98_expires_30_days.png"} 
										className="w-3 h-[15px] rounded-md object-fill"
									/>
								</button>
							...
							<div className="flex flex-col items-start py-4">
									...
									<div className="flex flex-col items-start gap-4">
										<div className="flex items-center bg-[#0D1117] py-[9px] px-3 rounded-md border border-solid border-[#30363D]">
											...
											<div className="flex shrink-0 items-start bg-[#30363D] py-[7px] px-2 gap-1.5 rounded">
												...
												<img
													src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/xcka2s26_expires_30_days.png"} 
										...
										<div className="flex flex-col items-end bg-[#30363D] pr-[161px] rounded-[9999px]">
											...
											<img
												src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/1wq38534_expires_30_days.png"} 
								...
								<div className="flex flex-col items-start bg-[#0D1117] py-3 mb-4 mx-4 rounded-lg">
									<div className="flex items-center mb-2 ml-3 gap-2">
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/rvj11jp8_expires_30_days.png"} 
