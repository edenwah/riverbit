			...
			<div className="self-stretch bg-white h-[1153px] rounded-lg border-2 border-solid border-[#CED4DA]">
				<div className="flex justify-between items-start self-stretch bg-[#161B22] py-3.5 px-4">
					<div className="flex shrink-0 items-start gap-8">
						<img
							src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/yd1rvakd_expires_30_days.png"} 
						...
						<div className="flex shrink-0 items-start">
							...
							<div className="flex shrink-0 items-center py-[11px] gap-[13px] rounded-md">
								...
								<img
									src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/v8z1q9ly_expires_30_days.png"} 
					...
					<div className="flex shrink-0 items-center gap-4">
						...
						<div className="flex shrink-0 items-center bg-[#161B22] py-2.5 px-3 gap-2 rounded-md border border-solid border-[#30363D]">
							<img
								src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/7lfrp484_expires_30_days.png"} 
								className="w-5 h-5 rounded-md object-fill"
							/>
							<img
								src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/udkjb8ww_expires_30_days.png"} 
								className="w-3 h-[15px] rounded-md object-fill"
							/>
						</div>
						<button className="flex shrink-0 items-center bg-[#161B22] text-left py-2.5 px-4 gap-2.5 rounded-md border border-solid border-[#30363D]"
							onClick={()=>alert("Pressed!")}>
							<img
								src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/sfjdjhog_expires_30_days.png"} 
							...
							<div className="flex justify-between items-start self-stretch mx-3">
								<div className="flex shrink-0 items-center gap-4">
									<div className="flex shrink-0 items-start pr-[1px] gap-2">
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/101d99j2_expires_30_days.png"} 
									...
									<div className="flex shrink-0 items-center p-3 gap-[13px] rounded-md">
										...
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/b844tuu7_expires_30_days.png"} 
											className="w-3 h-[15px] rounded-md object-fill"
										/>
									</div>
								</div>
								<div className="flex shrink-0 items-start gap-2.5">
									<button className="flex shrink-0 items-center bg-[#0D1117] text-left p-3 gap-[17px] rounded-md border border-solid border-[#30363D]"
										...
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/3ebbdejl_expires_30_days.png"} 
											className="w-3 h-[15px] rounded-md object-fill"
										/>
									</button>
									<button className="flex shrink-0 items-center bg-[#0D1117] text-left p-3 gap-4 rounded-md border border-solid border-[#30363D]"
										...
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/y8q43qo7_expires_30_days.png"} 
											className="w-3 h-[15px] rounded-md object-fill"
										/>
									</button>
								</div>
						...
						<div className="self-stretch bg-[#161B22] py-[1px] rounded-md border border-solid border-[#30363D]">
							...
							<div className="flex justify-between items-start self-stretch px-3 mx-[1px]">
								...
								<div className="flex shrink-0 items-center py-[15px] pl-2 pr-[7px] gap-[13px]">
									...
									<img
										src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/1h9e8b77_expires_30_days.png"} 
							...
							<div className="flex flex-col self-stretch py-3 mx-[1px] gap-2.5">
								<div className="self-stretch mx-3">
									...
									<div className="flex items-center self-stretch">
										<span className="text-white text-xs my-2" >
											{"9/12/2025 17:00:00"}
										</span>
										<span className="text-white text-xs my-2.5 ml-1" >
											{"HYPE"}
										</span>
										<span className="text-white text-xs my-2.5 ml-1 mr-[1px]" >
											{"8.09 HYPE"}
										</span>
										<span className="text-[#2DA44E] text-xs my-2.5 ml-1" >
											{"Long"}
										</span>
										<span className="text-[#2DA44E] text-xs my-2.5 ml-1 mr-[1px]" >
											{"$0.0012"}
										</span>
										<span className="text-white text-xs my-2.5 ml-1" >
											{"-0.0003%"}
								...
								<div className="flex flex-col items-end self-stretch">
									<div className="flex items-start mr-3 gap-4">
										<button className="flex flex-col shrink-0 items-start bg-[#92318D] text-left py-3.5 px-[19px] rounded-md border-0"
											onClick={()=>alert("Pressed!")}>
											<span className="text-white text-base font-bold" >
												{"View All"}
											</span>
										</button>
										<button className="flex flex-col shrink-0 items-start bg-[#92318D] text-left py-3.5 px-4 rounded-md border-0"
											onClick={()=>alert("Pressed!")}>
											<span className="text-white text-base font-bold" >
												{"Export as CSV"}
											</span>
					...
					<div className="flex flex-col shrink-0 items-center bg-[#161B22] rounded-md border border-solid border-[#30363D]">
						<div className="flex items-start p-3">
							...
							<button className="flex shrink-0 items-start bg-[#0D1117] text-left p-3 mr-2 gap-[11px] rounded-md border border-solid border-[#30363D]"
								...
								<img
									src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/he5ve1wj_expires_30_days.png"} 
									className="w-3 h-[15px] rounded-md object-fill"
								/>
							</button>
						...
						<div className="flex flex-col items-start py-4">
								...
								<div className="flex flex-col items-start gap-4">
									<div className="flex items-center bg-[#0D1117] py-[9px] px-3 rounded-md border border-solid border-[#30363D]">
										...
										<div className="flex shrink-0 items-start bg-[#30363D] py-[7px] px-2 gap-1.5 rounded">
											...
											<img
												src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/63tbv5wn_expires_30_days.png"} 
									...
									<div className="flex flex-col items-end bg-[#30363D] pr-[161px] rounded-[9999px]">
										...
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/m4d80ksu_expires_30_days.png"} 
							...
							<div className="flex flex-col items-start bg-[#0D1117] py-3 mb-4 mx-4 rounded-lg">
								<div className="flex items-center mb-2 ml-3 gap-2">
									<img
										src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/flvh8i92_expires_30_days.png"} 
