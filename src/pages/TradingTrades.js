...
export default (props) => {
	...
	return (
		<div className="flex flex-col bg-white">
			<div className="self-stretch bg-white h-[1153px] rounded-lg border-2 border-solid border-[#CED4DA]">
				<div className="flex justify-between items-start self-stretch bg-[#161B22] py-3.5 px-4">
					<div className="flex shrink-0 items-start gap-8">
						<img
							src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/cugoxidw_expires_30_days.png"} 
						...
						<div className="flex shrink-0 items-start">
							...
							<div className="flex shrink-0 items-center py-[11px] gap-[13px] rounded-md">
								...
								<img
									src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/s7xmz4qy_expires_30_days.png"} 
					...
					<div className="flex shrink-0 items-center gap-4">
						...
						<div className="flex shrink-0 items-center bg-[#161B22] py-2.5 px-3 gap-2 rounded-md border border-solid border-[#30363D]">
							<img
								src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/av3ud8da_expires_30_days.png"} 
								className="w-5 h-5 rounded-md object-fill"
							/>
							<img
								src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/7fe6j18o_expires_30_days.png"} 
								className="w-3 h-[15px] rounded-md object-fill"
							/>
						</div>
						<button className="flex shrink-0 items-center bg-[#161B22] text-left py-2.5 px-4 gap-2.5 rounded-md border border-solid border-[#30363D]"
							onClick={()=>alert("Pressed!")}>
							<img
								src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/xwt2ed5u_expires_30_days.png"} 
				...
				<div className="flex items-start self-stretch p-2 gap-2">
							...
							<div className="flex justify-between items-start self-stretch mx-3">
								<div className="flex shrink-0 items-center gap-4">
									<div className="flex shrink-0 items-start pr-[1px] gap-2">
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/4ddefqkk_expires_30_days.png"} 
									...
									<div className="flex shrink-0 items-center p-3 gap-[13px] rounded-md">
										...
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/z3lw948x_expires_30_days.png"} 
											className="w-3 h-[15px] rounded-md object-fill"
										/>
									</div>
								</div>
								<div className="flex shrink-0 items-start gap-2.5">
									<button className="flex shrink-0 items-center bg-[#0D1117] text-left p-3 gap-[17px] rounded-md border border-solid border-[#30363D]"
										...
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/tujbj5yt_expires_30_days.png"} 
											className="w-3 h-[15px] rounded-md object-fill"
										/>
									</button>
									<button className="flex shrink-0 items-center bg-[#0D1117] text-left p-3 gap-4 rounded-md border border-solid border-[#30363D]"
										...
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/ytydcir8_expires_30_days.png"} 
											className="w-3 h-[15px] rounded-md object-fill"
										/>
									</button>
								</div>
						...
						<div className="self-stretch bg-[#161B22] py-[1px] rounded-md border border-solid border-[#30363D]">
							...
							<div className="flex justify-between items-start self-stretch px-3 mx-[1px]">
								...
								<div className="flex shrink-0 items-center py-[15px] px-2 gap-[13px]">
									...
									<img
										src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/dv3sif10_expires_30_days.png"} 
					...
					<div className="flex flex-col shrink-0 items-center bg-[#161B22] p-[1px] rounded-md border border-solid border-[#30363D]">
						<div className="flex items-start px-3">
							<span className="text-[#8B949E] text-sm my-[15px] mx-[26px]" >
								{"Order Book"}
							</span>
							<span className="text-white text-sm my-[15px] mx-[41px]" >
								{"Trades"}
							</span>
						</div>
						<div className="flex flex-col items-center">
							...
							<div className="flex flex-col items-center gap-[1px]">
								<div className="flex items-start py-[7px] pr-[1px]">
									...
									<span className="text-[#8B949E] text-xs my-[3px] mx-7" >
										{"00:49:51"}
									</span>
								</div>
								<div className="flex items-start py-[7px] pr-[1px]">
									...
									<span className="text-white text-xs my-[3px] mx-[35px]" >
										{"0.31"}
									</span>
									<span className="text-[#8B949E] text-xs my-[3px] mx-7" >
										{"00:49:51"}
								...
								<div className="flex items-start py-[7px] pr-[1px]">
									...
									<span className="text-white text-xs my-[3px] mx-[34px]" >
										{"0.20"}
									</span>
									<span className="text-[#8B949E] text-xs my-[3px] mx-7" >
										{"00:49:51"}
								...
								<div className="flex items-start py-[7px] pr-[1px]">
									<span className="text-[#F85149] text-xs my-[3px] mx-4" >
										{"110,591.00"}
									</span>
									<span className="text-white text-xs my-[3px] mx-8" >
										{"1.146"}
								...
								<div className="flex items-start py-1.5 pr-[1px]">
									<span className="text-[#2DA44E] text-xs my-[3px] mx-[15px]" >
										{"110,589.00"}
									</span>
									<span className="text-white text-xs my-[3px] mx-8" >
								...
								<div className="flex items-start pr-[1px]">
									<span className="text-[#F85149] text-xs my-[9px] mx-[15px]" >
										{"110,590.00"}
									</span>
									<span className="text-white text-xs my-[9px] mx-[30px]" >
										{"2.852"}
									</span>
									<span className="text-[#8B949E] text-xs my-[9px] mx-7" >
										{"00:49:51"}
									</span>
								</div>
								<div className="flex items-start py-1.5 pr-[1px]">
					...
					<div className="flex flex-col shrink-0 items-center bg-[#161B22] rounded-md border border-solid border-[#30363D]">
						<div className="flex items-start p-3 gap-2">
							...
							<button className="flex shrink-0 items-start bg-[#0D1117] text-left p-3 gap-[11px] rounded-md border border-solid border-[#30363D]"
								...
								<img
									src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/5twatz2x_expires_30_days.png"} 
									className="w-3 h-[15px] rounded-md object-fill"
								/>
							</button>
						...
						<div className="flex items-start pl-3 pr-[13px]">
						...
						<div className="flex flex-col items-start py-4 gap-4">
							<div className="flex items-center bg-[#0D1117] py-1 pl-1 pr-[5px] mx-4 gap-6 rounded-md">
								...
								<div className="flex flex-col items-start gap-4">
									<div className="flex items-center bg-[#0D1117] py-[9px] px-3 rounded-md border border-solid border-[#30363D]">
										...
										<div className="flex shrink-0 items-start bg-[#30363D] py-[7px] pl-2 pr-[7px] gap-1.5 rounded">
											...
											<img
												src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/qdbco1eh_expires_30_days.png"} 
									...
									<div className="flex flex-col items-end bg-[#30363D] pr-[162px] rounded-[9999px]">
										...
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/z6ga2xaz_expires_30_days.png"} 
							...
							<div className="flex flex-col items-start bg-[#0D1117] py-3 mx-4 gap-2 rounded-lg">
								<div className="flex items-center mx-3 gap-2">
									<img
										src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/o6whblgj_expires_30_days.png"} 
