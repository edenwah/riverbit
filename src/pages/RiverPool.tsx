			...
			<div className="self-stretch bg-[#0D1117] h-[1648px] rounded-lg border-2 border-solid border-[#CED4DA]">
				<div className="flex justify-between items-start self-stretch bg-[#161B22] py-3.5 px-4">
					<div className="flex shrink-0 items-start gap-8">
						<img
							src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/ivlgz9ra_expires_30_days.png"} 
						...
						<div className="flex shrink-0 items-start">
							...
							<div className="flex shrink-0 items-center py-[11px] gap-[13px] rounded-md">
								...
								<img
									src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/ZlYhP85oka/gylxzdti_expires_30_days.png"} 
